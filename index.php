        ...
        <div class="wrapper" id="main">
            <div id="content">
                ...
                <nav class="navbar navbar-default">
                    <!-- <span id="sidebarCollapse" class="sidebarButton material-tooltip-smaller" data-toggle="tooltip" title="Opciones" data-placement="bottom"  onclick="open_bar()">
                    ...
                    <div class="vl1"></div>
                    <span class="graduation-icon iconButton material-tooltip-smaller dropbtn"  style="margin-left: 450px;" data-toggle="tooltip" title="Opciones de alumno" data-placement="left" onclick="myFunction()">
                        <i class="fas fa-graduation-cap fa-lg" style="color: white;" ></i> 
                    ...
                    <div class="vl2"></div>
                    <span class="teacher-icon iconButton material-tooltip-smaller " style="margin-left:50px;" data-toggle="tooltip" title="Iniciar sesión como profesor" data-placement="bottom" >
                        <i class="fas fa-chalkboard-teacher fa-lg" style="color: white;"></i>
                    </span>
                    <div class="vl3"></div>
                    <span class="contact-icon iconButton material-tooltip-smaller" style="margin-left:50px;" data-toggle="tooltip" title="contacto" data-placement="bottom" >
                        <i class="fas fa-tty fa-lg" style="color: white;"></i>
                    </span>
                    <div class="vl4"></div>
                    <img class="img_navbar" src="www/images/ipnBlanco.png" height="50" weight="50" style="margin-top: -1px; margin-left: 100px;">   
                </nav>
                <!---------------------------------------------------------------------------------------------------------------------------------------->
               ...
               <div class="col-md-6">
                  <div class="full">
                     <div class="slide_cont">
                        <h2>Centro de Estudios Científicos y Tecnológicos no. 3</h2>
                        <center><h2>"Estanislao Ramírez Ruíz"</h2>
                        <p>¡Bienvenid@ al sitio oficial de la academia de matemáticas turno matutino!</p></center>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="full">
                     <div class="slide_pc_img wow fadeInRight" data-wow-delay="1s" data-wow-duration="2s"> <img src="www/images/CECYT3.png" alt="#" /> </div>
                  </div>
               </div>
            </div>
         </div>
